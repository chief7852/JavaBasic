...
import	java.util.*;				//import는 다른패키지에 있는 클래스를 사용할때 쓴다
//Ctrl + Shift + O
...
public class SampleClass {
	...
	int field; //전역변수 : 클래스 전체 영역에서 사용하는 변수//초기화 하지 않아도 기본값으로 초기화된다.
	
	/*
	 * - 메서드 : 변수를 가지고 할 일 
	 * - 선언 방법 : 리턴타입 메서드명(파라미터){}
	 * - 파라미터(매개변수) : 실행에 필요한 정보
	 * - 리턴타입(반환타입) : 실행 후 돌여줘야하는 결과물
	 * 
	 */
	...
	void flowTest1(){
		...
		flowTest3();
		System.out.println("flowTest1시작 : 6");
	}
	void flowTest2(){
